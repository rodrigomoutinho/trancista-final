            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">Lista de Faturamento</h3>
                </div>
                <!-- /.card-header -->
                  ...
                  <div class="modal-dialog modal-lg ">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h5 class="modal-title">Ver Faturamento</h5>
                  ...
                  <tbody>
                    ...
                    while ($row=mysqli_fetch_array($ret)) {
                      ...
                      <tr> 
                        ...
                        <td><a href="#"  class=" edit_data" id="<?php echo  $row['BillingId']; ?>" title="click to view">Ver</a></td> 
