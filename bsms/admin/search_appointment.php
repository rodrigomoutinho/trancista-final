          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">Form Geral</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
        ...
        <div class="container-fluid">
            ...
            <div class="modal-dialog modal-lg ">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title">Ver Agendamento</h5>
            ...
            <div class="col-md-6">
              ...
              <div class="card card-info">
                <div class="card-header">
                  <h3 class="card-title">Procurar Agendamento</h3>
                </div>
                <div class="card-body">
          ...
          <div class="card-body col-md-12">
            ...
            { 
              ...
              ?>
              <h5 align="center" style="color: blue;" class="mb-3">Resultado Contra "<?php echo $sdata;?>" Palavra-chave </h4> 
              <table class="table table-bordered"> 
                <thead> 
                  <tr> 
                    <th>#</th> 
                    <th> Agendamento Número</th> 
                    <th>Nome</th>
                  ...
                  if($num>0){
                    ...
                    while ($row=mysqli_fetch_array($ret)) {
                      ...
                      <tr> 
                        ...
                        <td><a href="#" class=" edit_data" id="<?php echo  $row['ID']; ?>" title="click for edit">Ver</a></td>  
                        </tr>   <?php 
                        $cnt=$cnt+1;
                      } 
                    } else { ?>
