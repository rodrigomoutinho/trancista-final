  ...
  <ul class="navbar-nav ml-auto">
    ...
    <li class="nav-item dropdown">
      ...
      <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
        <span class="dropdown-item dropdown-header"><?php echo $num;?> Notificações</span>
        ...
        if($num2>0){
          while($result=mysqli_fetch_array($ret))
          {
            ...
            <a href="view-appointment.php?viewid=<?php echo $result['ID'];?>" class="dropdown-item">
              <i class="fas fa-envelope mr-2"></i> Agendamento de<?php echo $result['Name'];?>
            </a>
            <div class="dropdown-divider"></div>
            <?php
          }
        } else {?>
          <a class="dropdown-item" href="all_appointments.php">Nenhum agendamento recebido</a>
          <?php 
        } ?>


        <div class="dropdown-divider"></div>
        <a href="new_appointment.php" class="dropdown-item dropdown-footer">Verificar todos os Agendamentos</a>
      </div>
    </li>
    <li class="nav-item">
      ...
      <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
        ...
        <a href="changepassword.php" class="dropdown-item">
          <i class="fas fa-users mr-2"></i> Configurações 
        </a>
        <div class="dropdown-divider"></div>
