      ...
      <div class="col-lg-12">
        <div class="card mb-4">
          <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
            <h6 class="m-0 font-weight-bold text-primary">Atualizar Perfil de Usuário</h6>
          </div>
          <div class="card-body">
            <form method="post">
              <?php
                  ...
                  <div class="container rounded bg-white mt-5">
                    <div class="row">
                      <div class="col-md-4 border-right">
                        ...
                        <div class="mt-3">
                          <a href="update_userimage.php?id=<?php echo $id;?>">Editar Imagem</a>
                        </div>
                      </div>
                    </div>
                    <div class="col-md-8">
                      <div class="p-3 py-5">
                        ...
                        <div class="row mt-3">
                          <div class="col-md-6">
                            <label class="form-group">Nome de Usuário</label>
                            <input type="text" class="form-control" name="username" value="<?php  echo $row->username;?>" required></div>
                            <div class="col-md-6">
                              <label class="form-group">Permissões</label>
                              <input type="text" class="form-control"name="permission" value="<?php  echo $row->permission;?>" readonly="true"></div>
                            </div>

                           <div class="mt-5 text-right"><button class="btn btn-primary profile-button" type="submit" name="submit">Atualizar Perfil</button></div>
                         </div>
                       </div>
                     </div>
                   </div>
